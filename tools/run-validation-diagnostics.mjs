...
const checks = [
  ...
  'validate:tropical-arrival-time',
  'test:tropical-arrival-time-provider',
  'test:tropical-arrival-time-runtime',
  'validate:tropical-storm-surge',
  'test:tropical-storm-surge-provider',
  'test:tropical-storm-surge-runtime',
