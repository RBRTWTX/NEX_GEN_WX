...
assert.deepEqual(
  ...
  ['basemap', 'layer-style', 'roads', 'boundaries', 'cities', 'satellite', 'radar', 'tropical', 'tropical-outlook', 'alerts', 'observations', 'camera', 'interaction', 'layer-order', 'resize'],
...
console.log(`Built-in registry regression passed: ${ids.length} modules, ${providers.length} providers, and 15 map controllers verified.`);
